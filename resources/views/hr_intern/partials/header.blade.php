    ...
    <ul class="app-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right account-dropdown">
                <li>
                    {{-- <a class="dropdown-item" href="{{ route('salse.profile') }}"><i class="fa fa-user fa-lg"></i> Profile</a> --}}
                </li>
                <li>
                    <a class="dropdown-item" href="{{ route('user.logout') }}"><i class="fa fa-sign-out fa-lg"></i> Logout</a>
                </li>
            </ul>
        </li>
    </ul>
