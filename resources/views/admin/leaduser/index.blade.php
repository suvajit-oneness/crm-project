   ...
   <div class="fixed-row">
    <div class="app-title">
        ...
        <div class="col-md-6 text-right">
            <a href="{{ route('admin.user.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
                            ...
                            @foreach($users as $user_detail)
                                <tr>
                                    <td>
                                        ...
                                        <img style="width: 100px;height: 100px;" src="{{URL::to('/').'/User/'}}{{$user_detail->image}}">
                                        @endif
                                    </td>
                                    ...
                                    <td class="align-center">
                                       ...
                                       <div class="btn-group" role="group" aria-label="Second group">
                                        <a href="{{ route('admin.user.edit', $user_detail['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('admin.user.details', $user_detail['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-eye"></i></a>
