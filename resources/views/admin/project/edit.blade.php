                ...
                <form action="{{ route('admin.project.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('start_date') is-invalid @enderror" type="text" name="start_date" id="start_date" value="{{ old('start_date', $targetproject->start_date) }}"/>

                            @error('start_date') {{ $message }} @enderror
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="end_date">End Date </label>
                            <input class="form-control @error('end_date') is-invalid @enderror" type="text" name="end_date" id="end_date" value="{{ old('end_date', $targetproject->end_date) }}"/>
